...
/**
 * Accessible, original FAISI AI Authentication Modal (Login & Registration).
 * @param {{
 *   isOpen: boolean,
 *   onClose: () => void,
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Modal Header with FAISI Gradient */}
        <div className="p-6 pb-4 text-center border-b border-neutral-800/80 dark:border-neutral-800/80 light:border-neutral-200">
          ...
          >
            {mode === 'login' ? 'Welcome Back to FAISI AI' : 'Create Your FAISI AI Account'}
          </h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="pt-2">
            ...
            >
              {mode === 'login' ? 'Sign In to FAISI AI' : 'Create Account'}
            </Button>
          </div>
        </form>
